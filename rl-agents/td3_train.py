...
# TD3 agent setup
model = TD3('MlpPolicy', env_train, verbose=1, learning_rate=3e-4, buffer_size=1000000, learning_starts=1000,
            batch_size=256, tau=0.005, gamma=0.99, train_freq=1, gradient_steps=1, policy_delay=2, action_noise=None)

# Train the TD3 agent
model.learn(total_timesteps=200000)

# Save the model
model_path = TRAINED_MODEL_DIR + "/agent_td3_deepseek.pth"
